...
public class CourseServiceImp implements CourseService{
    ...
    public void listAllCourses() {
        ...
        if (courses.isEmpty()) {
            ...
            table.addCell("id".toUpperCase());
            table.addCell("title".toUpperCase());
            table.addCell("instructor".toUpperCase());
            table.addCell("requirement".toUpperCase());
            table.addCell("start date".toUpperCase());
